...
```bash
curl -X GET "https://account.viagogo.com/authorize?client_id=clientId&response_type=code&redirect_uri=https://myapp.com/callback&scope=read:sellerlistings%20write:sellerlistings&state=12345"
```
